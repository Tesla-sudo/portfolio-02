...
<div className='max-w-2xl w-full bg-white p-6 rounded-lg shadow mb-6'>
    ...
    <p className='mb-4 text-gray-800'>
        Frontend development lets me turn ideas into interactive experiences. It is a blend of logic
...
<div className='max-w-2xl w-full bg-white p-6 rounded-lg shadow mb-6'>
    ...
    <p className='mb-4 text-gray-800'>
        ...
        with others. It is helped sharpen my thinking and clarify my ideas.
    </p>
...
It is fun, informative and a great way to improve analytical skills and also help new brands grow.
    </p>
